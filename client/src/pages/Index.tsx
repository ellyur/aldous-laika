...
import cover1Image from '@assets/cover1_1760696719373.jpg';
import cover2Image from '@assets/cover2_1760696719372.jpg';
import cover3Image from '@assets/cover3_1760696719371.jpg';
...
const Index = () => {
  ...
  return (
    <AnimationContext.Provider value={{ animationsEnabled }}>
      ...
      >
        <source
          src="https://res.cloudinary.com/dkazjosk5/video/upload/v1760704595/ytmp3free.cc_ed-sheeran-perfect-youtubemp3free.org_qarruk.mp3"
          type="audio/mpeg"
        />
