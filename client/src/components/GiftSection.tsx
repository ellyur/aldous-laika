...
import bdoQrImage from '@assets/qr_1760703955259.jpg';
    ...
    >
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        >
          {/* GCash Payment */}
          <div>
            <div className="bg-card/30 border border-border rounded-xl p-8 shadow-soft hover-elegant h-full">
              ...
              <div className="space-y-2 text-center">
                <div>
                  ...
                  <p className="text-xl font-semibold text-primary-foreground" data-testid="text-gcash-number">
                    0956-9262818
                  </p>
                </div>
                <div>
          ...
          {/* BDO InstaPay Payment */}
          <div>
            <div className="bg-card/30 border border-border rounded-xl p-8 shadow-soft hover-elegant h-full">
              <h3 className="text-lg font-display font-semibold text-gold-bright mb-4 text-center">BDO InstaPay</h3>
              <div className="text-center mb-4">
                <img 
                  src={bdoQrImage}
                  alt="BDO InstaPay QR Code"
                  className="w-full max-w-sm mx-auto object-contain rounded-lg"
                  data-testid="img-bdo-qr"
                />
              </div>
              <div className="space-y-2 text-center">
                <div>
