...
import prenup1 from '@assets/soulmates_1760696719368.jpg';
import prenup2 from '@assets/forever_1760696719369.jpg';
import prenup3 from '@assets/beloved_1760696719370.jpg';
...
import image_removebg_preview__6_ from "@assets/image-removebg-preview (6).png";
        ...
        <div className="absolute -bottom-4 left-1/2 transform -translate-x-1/2">
          <div className="relative">
            <svg width="60" height="60" viewBox="0 0 60 60">
              <circle cx="30" cy="30" r="28" fill="#7a9f7f" opacity="0.9"/>
              <circle cx="30" cy="30" r="24" fill="#88a580"/>
            </svg>
            <div className="absolute inset-0 flex items-center justify-center">
              <img src={image_removebg_preview__6_} alt="I&R" className="h-16 w-16 object-contain" />
            </div>
            {/* Wax drips */}
