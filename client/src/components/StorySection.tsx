...
import { Sparkles, Compass, Heart, X } from 'lucide-react';
...
// Import new images
import promiseImage from '@assets/soulmates_1760696719368.jpg';
import futureImage from '@assets/forever_1760696719369.jpg';
import familyImage from '@assets/image-loop_1760702308754.jpg';
...
const StorySection = () => {
  ...
  const [isExpanded, setIsExpanded] = useState(false); // Added missing isExpanded state

  const storyCards = [
    {
      id: 1,
      title: "Our Love Story",
      summary: "They say love finds you when you least expect it. We were neighbors for years, until fate brought us together. Aldous showed me the loyalty and love I had been searching for.",
      fullText: "They say love finds you when you least expect it — and that's exactly how our story began. We had been neighbors for the longest time, yet fate waited for the perfect moment to bring us together. After a six-year relationship, Aldous came into my life when I was longing for something real, something true. In him, I saw the loyalty and love I had been searching for all along.",
      image: promiseImage,
      icon: Sparkles
    },
    {
      id: 2,
      title: "Fifteen Years Strong",
      summary: "Fifteen years later, our love continues to grow. We've been married for ten beautiful years, blessed with three wonderful children who are the living proof of our love story.",
      fullText: "Fifteen years later, our love continues to grow stronger each day. We've been married for ten beautiful years, blessed with three wonderful children who are living proof of our love story — one that began with friendship, blossomed with faith, and endures with love. As we celebrate this next chapter, we look back with grateful hearts — for destiny, for second chances, and for the kind of love that truly lasts a lifetime.",
      image: futureImage,
      icon: Compass
    },
    {
      id: 3,
      title: "Our Family",
      summary: "Our greatest blessing — a family built on love, faith, and joy. Together, we continue to write our beautiful story.",
      fullText: "Our greatest blessing — a family built on love, faith, and joy. Together, we continue to write our beautiful story.",
      image: familyImage,
      icon: Heart
    }
  ];
    ...
    >
      ...
      >
        ...
        >
          ...
          {storyCards.map((card, index) => (
            <div
              key={`card-${card.id}`} // Changed key to be unique
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="max-w-3xl max-h-[80vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle className="text-3xl font-script italic text-primary mb-4">Our Complete Love Story</DialogTitle>
          </DialogHeader>
